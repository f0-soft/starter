...
function init( config, callback ) {
	...
	// ----------------------------------
	SETTINGS.rabbit.redis = config.redis;
	...
	// rabbit
	SETTINGS.rabbit.co.gPath = links_dict;

	// view
	SETTINGS.view.links = links_dict;
	...
	for ( i = 0; i < files.length; i += 1 ) {
		...
		// controller
		SETTINGS.controller.config.viewConfig[ file.name ] = dict;
	}
